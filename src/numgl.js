// Taken from https://github.com/jongomez/numgl
    // which is not published to npm and so is not included as a dependency
    // but which i needed to copy into the project as a module so i could make 
...
var numgl = {
    ...
    init_canvas: function() {
        numgl.canvas = document.querySelector("canvas.shaded-portrait");
    ...
    convolution: function(textureId, kernel) {
      var matrixRows = Math.sqrt(kernel.length),
    ...
    fs_code: function(pretty) {
      ...
      var code = numgl.fsFloatPrecision +
    ...
    //   console.log("About to create a shrogram with the fragment shader code:\n\n", fsCode, "\nand vertex shader code:\n\n", vsCode)
